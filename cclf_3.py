...
if len(sys.argv) < 3:
    print("Usage: python cclf_3.py <number_of_file_days> <number_of_lines_per_file>")
...
def generate_files(file_date, contents):
    files = {
        ...
        f"P.A{random_alpha_string(3)}.ACO.ZC3R{random_alpha_string(2)}.D{file_date}.T010203t",
        f"P.F{random_alpha_string(3)}.ACO.ZC3Y{random_alpha_string(2)}.D{file_date}.T010203t",
        f"P.F{random_alpha_string(3)}.ACO.ZC3R{random_alpha_string(2)}.D{file_date}.T010203t",
        f"P.D{random_alpha_string(3)}.ACO.ZC3Y{random_alpha_string(2)}.D{file_date}.T010203t",
        f"P.D{random_alpha_string(3)}.ACO.ZC3Y{random_alpha_string(2)}.D{file_date}.T010203t",
        f"P.K{random_alpha_string(3)}.ACO.ZC3Y{random_alpha_string(2)}.D{file_date}.T010203t",
        f"P.C{random_alpha_string(3)}.ACO.ZC3Y{random_alpha_string(2)}.D{file_date}.T010203t",
        f"P.F{random_alpha_string(3)}.ACO.ZC3Y{random_alpha_string(2)}.D{file_date}.T010203t",
    }
...
for index in range(number_of_file_days):
    ...
    for _ in range(number_of_lines_per_file):
        ...
        contents = contents + random_alpha_string(7)    # CLM_PRCDR_CD
        contents = contents + random_date(datetime(2024, 1, 1), datetime(2024, 12, 31)) # CLM_PRCDR_PRFRM_DT
